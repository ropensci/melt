...
pairwise <- function(x, c, control = 0L, k = 1L, level = 0.05, interval = TRUE, method = "AMC", B = 1e4L, approx = FALSE, nthread = 1L, progress = TRUE, threshold = 50, maxit = 1e4L, abstol = 1e-8) {
    .Call(`_melt_pairwise`, x, c, control, k, level, interval, method, B, approx, nthread, progress, threshold, maxit, abstol)
}
