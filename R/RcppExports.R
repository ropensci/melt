...
eld_ <- function(method, par0, x, maxit, tol, th, w = NULL) {
    .Call(`_melt_eld_`, method, par0, x, maxit, tol, th, w)
}

eval_ <- function(method, par0, x, maxit, tol, th, w = NULL) {
    .Call(`_melt_eval_`, method, par0, x, maxit, tol, th, w)
}

eval_g_ <- function(g, maxit, tol, th, w = NULL) {
    .Call(`_melt_eval_g_`, g, maxit, tol, th, w)
}
...
lht_ <- function(method, par0, x, lhs, rhs, maxit, tol, th, w = NULL) {
    .Call(`_melt_lht_`, method, par0, x, lhs, rhs, maxit, tol, th, w)
}
...
mean_ <- function(par, x, maxit, tol, th, w = NULL) {
    .Call(`_melt_mean_`, par, x, maxit, tol, th, w)
}
