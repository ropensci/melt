...
#'
#' @srrstats {G1.2} Life cycle statement is included in .github/CONTRIBUTING.md.
...
#'   files.
#' @srrstatsNA {G5.11} Tests do not require large data sets.
#' @srrstatsNA {G5.11a} Tests do not download additional data sets.
